...
import com.mfs.dtos.PlayerMoveRequestDTO;
import com.mfs.dtos.BoardResponseDTO;
import com.mfs.dtos.PlayerTypeResponse;
import com.mfs.mappers.GameMapper;
...
import static com.mfs.MancalaMockData.*;
...
public class GameServiceUnitTest {
    ...
    @InjectMocks
    private GameService service = new GameService(gameMapper);

    @Test
    public void getSumAllStones() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("getSumAllStones", int[].class);
    ...
    public void getStolenStones() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("getStolenStones", int[].class, int.class);
        method.setAccessible(true);
    ...
    public void getFullBoardAfterStolen() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("getFullBoardAfterStolen", int[].class, int.class);
        method.setAccessible(true);
    ...
    public void getPlayerBoardPlayerOne() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("getPlayerBoard", PlayerTypeResponse.class, int[].class);
        method.setAccessible(true);
    ...
    public void getFullBoard() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("getFullBoard", MoveRequestDTO.class);
        method.setAccessible(true);
    ...
    public void initPlayerBoard() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("initPlayerBoard");
        method.setAccessible(true);
    ...
    public void getCurrentPlayerOneTurn() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("getCurrentPlayerTurn", MoveRequestDTO.class);
        method.setAccessible(true);
    ...
    public void boardPlayerOneIsFullZeros() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("boardPlayerIsFullZeros", MoveRequestDTO.class);
        method.setAccessible(true);
    ...
    public void boardPlayerOneIsFullZerosPlayerRequest() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("boardPlayerIsFullZeros", PlayerMoveRequestDTO.class);
        method.setAccessible(true);
    ...
    public void isValidMoveRequestPlayerOne() throws Exception {
        final Method method = GameService.class.getDeclaredMethod("isValidMoveRequest", MoveRequestDTO.class);
        method.setAccessible(true);
