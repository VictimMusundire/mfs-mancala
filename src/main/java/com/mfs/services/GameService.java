...
import static com.mfs.dtos.PlayerTypeResponse.*;
...
public class GameService {
    ...
    public MancalaResponseDTO startGame(StartRequestDTO startRequestDTO) {
        return gameMapper.startRequestDTOToMancalaResponseDTO(startRequestDTO, getRandomTurn(), initPlayerBoard());
    }
    ...
    public MancalaResponseDTO makeMove(MoveRequestDTO moveRequestDTO) {
        ...
        return gameMapper.moveRequestDTOToMancalaResponseDTO(moveRequestDTO, isEndedGame);
    }
    ...
    public EndGameResponseDTO endGame(EndGameRequestDTO endGameRequestDTO) {
        ...
        return gameMapper.endGameRequestDTOToEndGameResponse(isTie, List.of(playerEndGameResponseDTO1, playerEndGameResponseDTO2));
    }
